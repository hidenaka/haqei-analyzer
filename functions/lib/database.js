  ...
  os_manual: {
    1: {
      ...
      quests: [
        ...
        "タスクリストの中の一つを、あえて人に任せてみる。結果が自分の理想と違っても、それを受け入れる。",
      ],
    },
    2: {
      name: "坤為地",
      summary:
        "すべてを受け入れ、育む大地のエネルギーを持つOS。献身的でサポート能力に長けるが、自己主張が苦手な側面も持つ。",
      debug_pattern:
        "他者の要求をすべて受け入れてしまい、自分のキャパシティを超えて疲弊する。断ることができず、不満を溜め込み、最終的に無気力になる。",
      debug_method:
        "物理的に『自分のための領域』を確保することが重要。自分のデスクを整える、一人の時間を作るなど、他者に侵害されない聖域を持つことで、健全な境界線を引く感覚を取り戻せる。",
      quests: [
    ...
    3: {
      name: "水雷屯",
      summary:
        "産みの苦しみを乗り越える粘り強さと深い思考力を持つOS。混沌の中から新しい可能性を見出すが、一人で悩み、行動不能に陥りやすい。",
      debug_pattern:
        "思考の沼に沈み、誰にも相談できず孤立する。完璧な計画を立てようとして不安が大きくなり、最初の一歩が永遠に踏み出せなくなる。",
      debug_method:
        "思考を強制的に中断し、身体を動かすこと。「雷」のエネルギー（行動）で「水」の淀み（悩み）を打ち破るイメージ。",
      quests: [
    ...
    4: {
      name: "山水蒙",
      summary:
        "純粋な探求心と学ぶ力を持つOS。未知の世界に飛び込み、教えを素直に吸収するが、時に他者に依存し、自分の進むべき道を見失うことがある。",
      debug_pattern:
        "「教えてくれる人」がいないと何もできない状態に陥る。楽な道や耳障りの良い情報に流され、本質的な学びから逃避する。",
      debug_method:
        "「教わる」から「試す」へモードを切り替えること。得た知識を一つでも使い、小さな失敗を経験することが、自立への最大の近道。",
      quests: [
    ...
    5: {
      name: "水天需",
      summary:
        "好機をじっくりと待つことができる、忍耐力と大局観を持つOS。焦らず準備を進めることができるが、待ちすぎて好機を逃すこともある。",
      debug_pattern:
        "準備が完璧でないと不安になり、行動を起こせなくなる。「まだその時ではない」と言い訳をし、永遠に待ち続けてしまう。",
      debug_method:
        "「待つ」という行動に、具体的な期限と目的を設定すること。「いつまでに」「何を」待つのかを明確にすることで、無限の待機から脱出できる。",
      quests: [
    ...
    6: {
      name: "天水訟",
      summary:
        "正義感が強く、論理的な議論で白黒つけたがるOS。真実を追求する力があるが、人間関係で不必要な対立を生みやすい。",
      debug_pattern:
        "自分の正しさを証明するために、相手を徹底的に論破しようとする。勝ち負けに固執し、本来の目的や人間関係を破壊してしまう。",
      debug_method:
        "対立のエネルギーを「人」ではなく「問題」に向けること。「どうすればこの問題を解決できるか？」という協力のフレームに、相手を招待する意識を持つことが有効。",
      quests: [
    ...
    7: {
      ...
      debug_method:
        "集団の「規律」ではなく、構成員一人ひとりの「物語」に焦点を当てること。メンバーの個人的な目標や関心事に耳を傾ける時間が、冷徹な仮面を外すきっかけになる。",
      quests: [
    ...
    8: {
      ...
      debug_method:
        "「親しさ」と「目的」を切り離して考えること。今の行動が「ただ仲良くするため」なのか「共通の目的のため」なのかを自問する習慣が、進むべき道を示す。",
      quests: [
    ...
    9: {
      name: "風天小畜",
      summary:
        "大きな目標に向かって、地道な努力を積み重ねることができるOS。目先の障害に一喜一憂せず、粘り強く進めるが、時に状況を打開する力が不足する。",
      debug_pattern:
        "小さな障害や邪魔によって、完全に動きが止められてしまう。無力感に苛まれ、どうせ無理だと諦めて、努力を放棄してしまう。",
      debug_method:
        "「今は我慢の時」と割り切り、エネルギーの浪費を止めること。進むのではなく、「蓄える」ことに意識を集中させ、次の追い風を待つ。",
      quests: [
    ...
    10: {
      name: "天沢履",
      summary:
        "礼儀を重んじ、危険な状況でも慎重に行動できるOS。社会的規範を遵守し、安定した評価を得るが、時に臆病で保守的になりすぎる面がある。",
      debug_pattern:
        "前例やルールがないと一歩も動けなくなる。リスクを恐れるあまり、絶好のチャンスを目の前にしても見送ってしまう。",
      debug_method:
        "「虎の尾を踏む」覚悟を決めること。安全な場所から出て、管理された小さなリスクを取る経験が、行動範囲を広げる鍵。",
      quests: [
    ...
    11: {
      name: "地天泰",
      summary:
        "穏やかで安定し、物事がスムーズに進む調和のOS。誰とでも良好な関係を築けるが、平和に慣れすぎて、危機への感度が鈍くなることがある。",
      debug_pattern:
        "「まあ、大丈夫だろう」と問題を先送りする。現状維持が最善だと考え、変化を促す意見を「波風を立てるもの」として退けてしまう。",
      debug_method:
        "あえて「最悪のシナリオ」を考えてみること。今の平和が崩れるとしたら、何が原因になるかを想像する訓練が、危機管理能力を呼び覚ます。",
      quests: [
    ...
    12: {
      name: "天地否",
      summary:
        "閉塞感の中で、じっと耐え、本質を見極める内省のOS。他者と距離を置き、孤高を保つが、その状態が長引くと、完全に孤立し、無気力になる。",
      debug_pattern:
        "世の中や他者に対する不満と諦めが募り、心を閉ざしてしまう。「どうせ誰も理解してくれない」と、あらゆるコミュニケーションを拒絶する。",
      debug_method:
        "外との「接点」を意図的に作ること。挨拶をする、メールに一言感謝を添えるなど、どんなに小さなことでも、閉塞した空気に風穴を開ける一歩になる。",
      quests: [
    ...
    13: {
      name: "天火同人",
      summary:
        "公平無私な精神で、多くの人々と協力関係を築くことができるOS。オープンなコミュニケーションを好むが、時に理想論に走り、現実的な対立から目を背ける。",
      debug_pattern:
        "「みんな仲良く」という理想に固執するあまり、見て見ぬふりをする。水面下で燻る不和や対立を放置し、結果的に組織が機能不全に陥る。",
      debug_method:
        "「同」の中に潜む「異」を直視する勇気を持つこと。全員が完全に同じ意見である必要はないと認め、健全な対立を恐れない姿勢が、真の結束を生む。",
      quests: [
    ...
    14: {
      name: "火天大有",
      summary:
        "太陽のように明るく、多くのものを所有し、人々に与えることができる寛大なOS。しかし、その豊かさが慢心や傲慢につながる危険性を常に内包している。",
      debug_pattern:
        "自分の成功や能力を誇示し、無意識のうちに他者を見下してしまう。与えることの喜びに酔いしれ、相手の真のニーズが見えなくなる。",
      debug_method:
        "「所有」から「預託」へ意識を切り替えること。自分の富や才能は「天から一時的に預かっているもの」と考え、その管理責任を意識することで、謙虚さを取り戻せる。",
      quests: [
    ...
    15: {
      name: "地山謙",
      summary:
        "実力がありながらも常に控えめで、誰からも愛される謙虚のOS。しかし、その謙虚さが行き過ぎると、自己を過小評価し、リーダーシップを発揮する機会を逃す。",
      debug_pattern:
        "「私なんて」が口癖になり、称賛や責任ある立場を頑なに拒否する。自分の意見を言わなくなり、結果的に周囲に面倒をかけてしまうことがある。",
      debug_method:
        "「謙遜」と「卑下」は違うと認識すること。自分の功績や能力を、事実として客観的に認める訓練が必要。",
      quests: [
    ...
    17: {
      name: "沢雷随",
      summary:
        "時代の変化や他者の意見に、柔軟に従い、流れに乗ることができるOS。しかし、主体性を失い、誰かに依存したり、軽率な判断を下したりする危険がある。",
      debug_pattern:
        "自分の頭で考えなくなり、強いリーダーや流行に盲目的に追従する。「みんながそう言っているから」が判断基準になり、自分の本心を見失う。",
      debug_method:
        "流れに「随う」前に、一瞬立ち止まって「なぜ？」と自問する癖をつけること。自分の価値観という「錨」を下ろすことで、流されずに済む。",
      quests: [
    ...
    18: {
      ...
      debug_method:
        "改革（山）の前に、丁寧なコミュニケーション（風）を意識すること。なぜ改革が必要なのかを粘り強く説明し、人々の心を動かすことが、無用な抵抗を減らす。",
      quests: [
    ...
    19: {
      ...
      debug_method:
        "「慈愛（地）」と「規律（沢の緊張感）」のバランスを取ること。優しさの中に、一本筋の通った厳しさを持つことが、真のリーダーシップに繋がる。",
      quests: [
    ...
    20: {
      ...
      debug_method:
        "「観察（観）」したことから得た「仮説」を、一つでもいいので「実行」してみること。不完全なままでの行動が、机上の空論からあなたを解放する。",
      quests: [
    ...
    21: {
      ...
      debug_method:
        "「噛み砕く（噬嗑）」前に、一度「飲み込む」プロセスを挟むこと。問題の背景や相手の事情を、まず情報として受け止め、理解しようと努めることが、より賢明な解決策に繋がる。",
      quests: [
    ...
    22: {
      ...
      debug_method:
        "すべての「飾り」を剥ぎ取った、素の自分を肯定すること。誰も見ていない場所で、自分が本当に心地よいと感じる服装や過ごし方をすることが、内なる自信を回復させる。",
      quests: [
    ...
    23: {
      ...
      debug_method:
        "剥がれ落ちたものの中に、唯一残る「種子」を見つけ出すこと。全てを失うように見えても、次代に繋がる本質的な価値が何かを探す視点が、希望を生む。",
      quests: [
    ...
    24: {
      ...
      debug_method:
        "「立ち返る（復）」ための、具体的な「道標」を設定すること。目標とする人物や、守るべきルールを明確に意識することで、進むべき方向がブレなくなる。",
      quests: [
    ...
    25: {
      name: "天雷无妄",
      summary:
        "天真爛漫で、自然体でいることを良しとするOS。作為や私心がなく、純粋だが、それ故に予期せぬ災難に巻き込まれやすい側面も持つ。",
      debug_pattern:
        "「あるがまま」を行き過ぎて、無防備・無計画になる。状況を顧みない無邪気な行動が、周囲に迷惑をかけたり、自身を危険に晒したりする。",
      debug_method:
        "「天の理」と「人の理」の両方を尊重すること。純粋な心を保ちつつも、社会的なルールや現実的なリスク管理の必要性を学ぶことが、身を守る知恵となる。",
      quests: [
    ...
    26: {
      ...
      debug_method:
        "蓄えたものを、少しずつ「試す」こと。インプットとアウトプットの小さなサイクルを回し始めることが、力を飼い慣らす訓練になる。",
      quests: [
    ...
    27: {
      name: "山雷頤",
      summary:
        "自分自身と他者を、物質的・精神的に「養う」ことをテーマとするOS。言葉を慎み、本質的な栄養を求めますが、時に自分の殻に閉じこもり、行動が鈍ります。",
      debug_pattern:
    ...
    28: {
      ...
      debug_method:
        "「大過（大きな通り過ぎ）」のエネルギーを、日常の「小過（小さな通り過ぎ）」に分散させること。全てのことに120%で臨むのではなく、力の抜きどころを覚えるのが課題。",
      quests: [
    ...
    29: {
      ...
      debug_method:
        "「水」の流れに身を任せつつも、岸辺に上がって休む時間を意識的に作ること。困難を乗り越えることだけでなく、その経験から何を学んだかを言語化することが、成長に繋がる。",
      quests: [
    ...
    31: {
      ...
      debug_method:
        "「感じる（咸）」ことと、「行動する」ことの間に、意図的に「思考する」というワンクッションを置くこと。感じたことを客観的な言葉に直す作業が、感情の波に飲まれないための防波堤になる。",
      quests: [
    ...
    32: {
      ...
      debug_method:
        "「恒（恒常性）」とは「不変」ではないと知ること。核となる理念は変えずに、時代や状況に合わせてやり方を「変化」させ続けることが、真の持続力に繋がる。",
      quests: [
    ...
    33: {
      ...
      debug_method:
        "「逃げる（遯）」のではなく、「距離を取る」という意識を持つこと。全てをシャットアウトするのではなく、自分が快適でいられる適切な距離を見つけるゲームだと捉える。",
      quests: [
    ...
    34: {
      ...
      debug_method:
        "行動（雷）の前に、一度立ち止まり、天の理（天）、つまり大局的な視点や道理に合っているかを確認すること。パワーだけでなく、戦略を持つことが暴走を防ぐ。",
      quests: [
    ...
    35: {
      ...
      debug_method:
        "評価（火）の基盤となる、自分自身の大地（地）を固めること。他者からの評価ではなく、自分が何を積み重ねてきたかという「事実」に自信を持つことが、承認欲求から解放される鍵。",
      quests: [
    ...
    36: {
      ...
      debug_method:
        "心の中の小さな光（火）を、完全に消さないこと。信頼できる一人にだけ本音を話す、好きなことに没頭するなど、心の灯火を守るための安全基地を確保する。",
      quests: [
    ...
    37: {
      ...
      debug_method:
        "家（内）の中に、外の「風」を入れること。意識的に外部の人と交流する機会を持ったり、全く違う分野の情報をインプットしたりすることが、停滞を防ぐ。",
      quests: [
    ...
    38: {
      ...
      debug_method:
        "「違うこと」と「敵対すること」は違うと理解すること。相手との違いを、新たな視点を与えてくれる「ギフト」として捉え直す訓練が必要。",
      quests: [
    ...
    39: {
      ...
      debug_method:
        "「進む」のではなく、「戻って仲間と合流する」という選択肢を思い出すこと。一人で越えられない山（蹇）も、協力者がいれば乗り越えられると信じること。",
      quests: [
    ...
    40: {
      ...
      debug_method:
        "問題が「解けた」後、なぜその問題が起きたのかを振り返る時間を設けること。氷が溶けた後の水溜まりを、静かに眺めるような時間が必要。",
      quests: [
    ...
    42: {
      ...
      debug_method:
        "「与える（益す）」ことと、「受け取る」ことのバランスを取ること。他者の助けや厚意を、感謝して受け取る訓練が必要。",
      quests: [
    ...
    44: {
      ...
      debug_method:
        "出会ったものを「吟味する」というフィルタを持つこと。全ての出会いが自分にとってプラスとは限らないと理解し、受け入れるものと断るものを冷静に選択する。",
      quests: [
    ...
    45: {
      ...
      debug_method:
        "集まった人々と「何を成し遂げるのか」という共通の目的（地）を再確認すること。楽しい交流（沢）のエネルギーを、具体的な成果に結びつける意識が求められる。",
      quests: [
    ...
    46: {
      ...
      debug_method:
        "自分の努力（地）を、客観的な視点（風）で俯瞰すること。定期的に立ち止まり、専門家の意見を聞いたり、他者のやり方を参考にしたりすることで、軌道修正が可能になる。",
      quests: [
    ...
    47: {
      ...
      debug_method:
        "どんな小さなことでもいいので、「喜び（沢）」の感覚を取り戻すこと。美味しいものを食べる、好きな音楽を聴くなど、五感が喜ぶ体験が、淀んだ水（困）に光を差し込む。",
      quests: [
    ...
    48: {
      ...
      debug_method:
        "井戸の「水質調査」を定期的に行うこと。つまり、自分の提供している価値が、今も本当に求められているのかを、謙虚に市場や他者に問いかける必要がある。",
      quests: [
    ...
    49: {
      name: "沢火革",
      summary:
        "古い体制や常識を打ち破り、全く新しいものへと変革する革命のOS。理想に燃え、大胆な行動ができるが、その過程で多くのものを破壊し、反発を招く。",
      debug_pattern:
        "改革のための改革に陥り、ただ壊すこと自体に快感を覚えてしまう。理想を追い求めるあまり、現実的な着地点を見失い、周囲を混乱に陥れる。",
      debug_method:
        "革命（革）のビジョンだけでなく、革命後の「新しい秩序（火）」を具体的に示すこと。壊した後に何を創るのかを明確に語ることで、人々はあなたについてくる。",
      quests: [
    ...
    50: {
      ...
      debug_method:
        "安定した鼎（かなえ）の足元で、常に新しい「火」を燃やし続けること。定期的に新しいメンバーを入れたり、外部の刺激を取り入れたりする仕組みが、組織の硬直化を防ぐ。",
      quests: [
    ...
    51: {
      ...
      debug_method:
        "行動（雷）の後に、必ず「振り返り（内省）」の時間を設けること。自分の起こした衝撃が、周囲にどのような影響を与えたかを冷静に分析することで、衝動は経験へと変わる。",
      quests: [
    ...
    52: {
      ...
      debug_pattern:
        "思考の無限ループに陥り、行動や決断を完全に停止させてしまいます。あらゆるリスクを想定しすぎて身動きが取れなくなり、他者との関わりを断絶します。",
      debug_method:
    ...
    54: {
      ...
      debug_method:
        "関係性の「始まり（雷の衝動）」だけでなく、「終わり（結末）」を想像してみること。今の行動が、1年後にどのような結果をもたらすかを冷静に考える視点が、暴走にブレーキをかける。",
      quests: [
    ...
    56: {
      ...
      debug_pattern:
        "どこにいても「所詮ここは仮の宿」と心を閉ざし、深く人と関わろうとしない。孤独感が強まり、皮肉屋になったり、突然全てを捨てて去ったりする。",
      debug_method:
        "旅（旅）の途中で、意識的に「根を下ろす」体験をすること。行きつけのカフェを作る、地域の活動に参加するなど、一時的でも「ホーム」と呼べる場所を持つことが、孤独感を和らげる。",
      quests: [
    ...
    57: {
      ...
      debug_pattern:
        "八方美人になり、誰に対しても良い顔をしようとして、信用を失う。決断を迫られると、姿を消したり、他人の意見に丸乗りしたりする。",
      debug_method:
        "風（巽）としての自分の「使命」を明確にすること。「何を伝えるために」「どこに浸透したいのか」という軸を持つことで、ただ流されるだけの存在から脱却できる。",
      quests: [
    ...
    58: {
      ...
      debug_method:
        "「喜び（兌）」の源泉を、外部の刺激から、自分の内側に見出すこと。誰かと一緒でなくても、一人で静かに感じられる喜びや満足感を探すことが、精神的な成長に繋がる。",
      quests: [
    ...
    60: {
      ...
      debug_method:
        "「節度」とは、単なる禁止ではなく、「楽しむためのルール」であると捉え直すこと。決められた範囲の中で、いかに創造性を発揮できるか、というゲーム感覚が、窮屈さから解放する。",
      quests: [
    ...
    61: {
      ...
      debug_method:
        "「真心（孚）」と「現実」の間に、健全な境界線を引くこと。相手を信じることと、客観的な事実を確認することは両立すると理解することが、あなたを守る。",
      quests: [
    ...
    62: {
      name: "雷山小過",
      summary:
        "大きな目標よりも、目の前の小さなことを、少しだけ度を過ごすくらい丁寧にこなすOS。慎重で謙虚だが、大きなビジョンを描いたり、大胆な行動を取ったりするのが苦手。",
      debug_pattern:
        "失敗を恐れるあまり、石橋を叩きすぎて壊してしまう。過剰な配慮が、かえって相手を疲れさせたり、行動を阻害したりする原因になる。",
      debug_method:
        "「少しだけ過ぎる（小過）」エネルギーを、ポジティブな方向に使うこと。他者への配慮ではなく、自分へのご褒美や、仕事のクオリティを「少しだけ」上げる方向で、その丁寧さを発揮する。",
      quests: [
    ...
    63: {
      ...
      debug_method:
        "「完成（既済）」は「終わり」ではなく、「次の未済（みせい）の始まり」であると認識すること。安定を維持しつつも、常に次の改善点やリスクを探す視点が、あなたを時代の変化から取り残されるのを防ぐ。",
      quests: [
    ...
    64: {
      ...
      debug_method:
        "「未済（未完成）」の状態そのものを楽しむこと。ゴールに到達することだけが目的ではなく、試行錯誤のプロセス自体が学びであり、価値なのだと捉え直すことが、焦りからあなたを解放する。",
      quests: [
  ...
  bible: {
    ...
    sho_den: {
      ...
      7: {
        ...
        reason:
          "ここでは、個々のリーダーシップを超越し、全ての要素が完全に調和した理想的な状態が示されています。全ての龍が自律的に機能し、中央集権的な支配者を必要としない究極の協働体制が実現します。",
      },
      8: {
      ...
      119: {
        ...
        reason:
          "周囲の状況は観察できていますが、肝心な自分自身の姿や立場が見えていない状態だからです。その客観性の欠如が、あなたの判断を誤らせ、股を傷つけるような失敗に繋がります。",
      },
      120: {
      ...
      214: {
        ...
        reason:
          "左の股を負傷し、自力で進むことが困難な状況です。しかし、力強い協力者（馬）の出現によって、あなたはその危機を乗り越えることができます。今は他者の助けを素直に受け入れるべきです。",
      },
      215: {
