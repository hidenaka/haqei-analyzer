...
export const HAQEI_DATA = {
  ...
  bible: {
    ...
    tai_sho_den: {
      ...
      30: {
        symbolism:
          "太陽（火）と月（火）のように、二つの明かりが重なり合う風景。",
        strategy:
          "先人の明智を受け継ぎ、その光で世の中の隅々までを照らし続ける。",
      },
      31: {
      ...
      35: {
        ...
        strategy:
          "自分から進んで、自らが持つ素晴らしい徳を世の中に明らかにする。",
      },
      36: {
      ...
      60: {
        ...
        strategy:
          "物事の適切な基準（数度）を定め、何が徳のある行いかを議論する。",
      },
      61: {
...
export const H64_PROFILE_VECTORS = {
  1: {
    hexagram_id: 1,
    name_jp: "乾為天",
    profile_vector: {
