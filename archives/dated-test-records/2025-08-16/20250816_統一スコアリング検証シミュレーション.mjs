...
// グローバル変数として定義
let unifiedQuestions, UNIFIED_SCORING;
...
// window から変数を取得
unifiedQuestions = global.window.unifiedQuestions || unifiedQuestions;
UNIFIED_SCORING = global.window.UNIFIED_SCORING || UNIFIED_SCORING;
