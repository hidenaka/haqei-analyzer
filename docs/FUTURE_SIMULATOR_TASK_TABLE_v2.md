...
| **`haqei-programmer`** | Phase 1-2 | bunenjin準拠コーディング | 80時間 |
| **`haqei-iching-expert`** | Phase 2 | 易経理論実装 | 64時間 |
| **`haqei-qa-tester`** | 全フェーズ | 品質保証・テスト | 48時間 |
| **`bunenjin-strategy-navigator`** | Phase 3 | 哲学的UX設計 | 32時間 |
