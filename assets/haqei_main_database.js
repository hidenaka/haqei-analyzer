...
os_manual: {
    ...
    "18":{name:"山風蠱",summary:"放置されて腐敗した問題を、根本から立て直す強い意志と責任感を持つOS。しかし、改革への情熱が強すぎて、周囲との軋轢を生むことがある。",debug_pattern:"問題の根源を断つことに固執し、人の感情や既存の秩序を無視した、強引で破壊的な改革を進めてしまう。正義感から、他者を断罪し始める。",debug_method:"改革（山）の前に、丁寧なコミュニケーション（風）を意識すること。なぜ改革が必要なのかを粘り強く説明し、人々の心を動かすことが、無用な抵抗を減らす。",quests:["改革案を提示する前に、その改革によって不利益を被る可能性のある人の話を、一対一で聞いてみる。","「壊す」ことだけでなく、「新しく創る」ことのビジョンを具体的に語る。"]},
