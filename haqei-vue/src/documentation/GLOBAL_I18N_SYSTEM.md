# HaQei Analyzer - グローバル多言語対応システム

## 🌍 概要

HaQei Analyzerの多言語対応システムは、50+言語・文化圏をサポートし、bunenjin哲学と易経の叡智を世界中のユーザーに届けるための包括的な国際化基盤です。
...
*bunenjin哲学と易経の叡智を、世界中の言語と文化で共有する。それがHaQei Analyzerの使命です。*
