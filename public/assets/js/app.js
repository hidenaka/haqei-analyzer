...
class DevModeManager {
    ...
    showMockDataSelector() {
        ...
        content.innerHTML = `
            ...
            <div style="margin: 15px 0;">
                <button onclick="window.devModeManager.setMockData('balanced')" style="margin: 5px; padding: 10px; border: 1px solid #ddd; border-radius: 5px; cursor: pointer;">バランス型</button>
                <button onclick="window.devModeManager.setMockData('creative')" style="margin: 5px; padding: 10px; border: 1px solid #ddd; border-radius: 5px; cursor: pointer;">創造型</button>
                <button onclick="window.devModeManager.setMockData('social')" style="margin: 5px; padding: 10px; border: 1px solid #ddd; border-radius: 5px; cursor: pointer;">社交型</button>
                <button onclick="window.devModeManager.setMockData('cautious')" style="margin: 5px; padding: 10px; border: 1px solid #ddd; border-radius: 5px; cursor: pointer;">慎重型</button>
            </div>
            <button onclick="this.parentElement.parentElement.remove()" style="margin-top: 10px; padding: 8px 15px; background: #666; color: white; border: none; border-radius: 5px; cursor: pointer;">閉じる</button>
        `;
    ...
    initializeMockProfiles() {
        this.mockProfiles = {
            balanced: {
                engineOS: { name: "創造", score: 75, hexagram: "乾" },
                interfaceOS: { name: "協調", score: 70, hexagram: "坤" },
                safeModeOS: { name: "慎重", score: 65, hexagram: "屯" },
                timestamp: Date.now(),
                userAnswers: this.generateMockAnswers(70, 'balanced')
            },
            creative: {
                engineOS: { name: "創造", score: 95, hexagram: "乾" },
                interfaceOS: { name: "表現", score: 85, hexagram: "離" },
                safeModeOS: { name: "挑戦", score: 45, hexagram: "震" },
                timestamp: Date.now(),
                userAnswers: this.generateMockAnswers(85, 'creative')
            },
            social: {
                engineOS: { name: "共感", score: 60, hexagram: "兌" },
                interfaceOS: { name: "協調", score: 90, hexagram: "坤" },
                safeModeOS: { name: "安定", score: 80, hexagram: "艮" },
                timestamp: Date.now(),
                userAnswers: this.generateMockAnswers(77, 'social')
            },
            cautious: {
                engineOS: { name: "分析", score: 55, hexagram: "坎" },
                interfaceOS: { name: "慎重", score: 65, hexagram: "艮" },
                safeModeOS: { name: "安全", score: 95, hexagram: "坤" },
                timestamp: Date.now(),
    ...
    setMockData(profileType) {
        ...
        if (!mockData) {
            console.error('無効なプロファイルタイプ:', profileType);
            return;
        }
        ...
        this.showDevNotification(`${profileType}プロファイル設定完了`);
