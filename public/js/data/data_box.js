...
// Interface OS / SafeMode OS分析用のキーワードマップ
var keyword_map = {
  "乾_創造性": [1, 13, 25, 33, 44],
  "震_行動性": [3, 16, 51, 21, 42],
  "坎_探求性": [5, 29, 39, 48, 60],
  "艮_安定性": [4, 15, 23, 26, 27, 46, 52],
  "坤_受容性": [2, 7, 8, 11, 19, 20, 24, 35, 36, 45],
  "巽_適応性": [9, 18, 37, 46, 53, 57, 59],
  "離_表現性": [10, 14, 22, 30, 38, 49, 56],
  "兌_調和性": [6, 10, 17, 28, 31, 41, 43, 47, 54, 58, 61]
};

// SafeMode OS分析用のライン（爻）キーワードマップ
var line_keyword_map = {
  "初爻_始まり": [1, 3, 5, 11, 25, 34],
  "二爻_協力": [2, 8, 16, 20, 45],
  "三爻_転換": [4, 18, 22, 41, 52],
  "四爻_進展": [9, 14, 26, 37, 53],
  "五爻_統合": [6, 13, 30, 49, 55],
