...
const HexagramHumanTraitsV3 = {
    ...
    "澤水困": {
        ...
        "asInterfaceOS": {
            ...
            "bestEnvironment": {
                ...
                "withWho": "困難を恐れない勇敢な人々",
                "avoid": "安楽で快適な居心地の良い環境"
            },
            "relationshipTips": {
                "strength": "困難を通じた深い絆",
                "weakness": "平和な時に物足りない",
    ...
    "雷澤帰妹": {
        ...
        "asSafeModeOS": {
            ...
            "stressResponse": {
                ...
                "example": "困った → 人間関係で解決",
                "goodPoint": "周囲から支援を得やすい人徳の持ち主",
                "badPoint": "自立性に欠ける依存的な傾向"
            },
            "emergencyMode": {
                "whatHappens": "全ての関係を動員",
                "example": "みんなに助けを求める",
                "recovery": "関係修復と共に成長する力",
                "timeToRecover": "関係性により2週間程度で回復"
            },
            "howToRecover": {
                "bestWay": "関係性を再構築する修復力",
                "example": "信頼関係を取り戻す",
                "environment": "支援的で温かい環境",
                "support": "深く理解してくれる仲間"
            }
        },
        "osBalance": {
    ...
    "巽為風": {
        "id": 57,
        "symbol": "☴",
        "element": "風のように浸透する影響力",
        "nickname": "静かに浸透する影響力の人",
        "emoji": "🌬️",
        "asEngineOS": {
            "profile": {
                "type": "浸透拡散エンジン",
            ...
            "restMode": {
                ...
                "howToRest": "流れを読む時間を持つ洞察力",
                "note": "次の浸透先を探す"
            },
            "maintenance": {
                "whatYouNeed": "浸透できる隙間を見つける観察力",
    ...
    "兌為澤": {
        "id": 58,
        "symbol": "☱",
        "element": "澤のような豊かな喜びの力",
        "nickname": "喜びを分かち合う明るい人",
        "emoji": "😊",
        "asEngineOS": {
            "profile": {
                "type": "喜び生成エンジン",
